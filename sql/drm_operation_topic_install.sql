...
-- 插入示例数据
INSERT INTO drm_operation_topic (topic_name, topic_type, target_dept, analysis_model, data_config, status, create_by, remark) VALUES
('骨科运营分析', '科室分析', '骨科', '对比分析', '{"metrics":["门诊量","住院量","手术量","收入"],"period":"last30days"}', '0', 'admin', '骨科科室近30天运营数据对比分析'),
('心内科DRG分析', 'DRG分析', '心内科', '趋势分析', '{"metrics":["DRG组数","CMI值","费用消耗指数","时间消耗指数"],"period":"last90days"}', '0', 'admin', '心内科DRG相关指标趋势分析'),
('全院成本分析', '成本分析', NULL, '分布分析', '{"metrics":["人力成本","材料成本","设备成本","药品成本"],"period":"lastmonth"}', '0', 'admin', '全院上月成本分布分析'),
('内科病种分析', '病种分析', '内科', '聚类分析', '{"metrics":["病种数量","平均住院日","次均费用"],"period":"lastquarter"}', '0', 'admin', '内科主要病种聚类分析');
